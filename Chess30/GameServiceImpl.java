public class GameServiceImpl implements Game{
    ...
    Cell [][] board;
    Integer m,n;
    public GameServiceImpl(Player blackPlayer, Player whitePlayer, Cell[][] board, Integer m, Integer n) {
    ...
    public void startGame(Piece piece, Integer startX, Integer startY, Integer endX, Integer endY) {
        ...
        if(isCheckmate()) {
            System.out.println("Winner : "+(turn?blackPlayer.getName():whitePlayer.getName()));
        }
        if(isStalemate()) {
