...
public class Main {
    public static void main(String[] args) {
        ...
        subjects=List.of("Buisness Studies","Accountancy","Economics");
        Student mbaStudent=new StudentBuilder().setId(2).setFirstName("Ravi").setLastName("Ravi").setEmail("ravi@email.com").setSubjects(subjects).build();
