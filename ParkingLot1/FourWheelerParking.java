...
public class FourWheelerParking implements ParkingSpaceType{
    public int inTime,outTime;
    HashMap<String,Integer> vehicles;
    public FourWheelerParking() {
        this.vehicles = new HashMap<>();
    }

    @Override
    public boolean validate(VehicleType type) {
        return (type==VehicleType.FOUR_WHEELER);
    }
    ...
    public int cost(String vehicleNo) {
        int parkingcost=(this.outTime-this.inTime)*15;
